...
"}")
    ...
    def retranslateUi(self, SplashScreen):
        ...
        self.label_title.setText(QCoreApplication.translate("SplashScreen", u"<strong>Misilleme</strong> Takibi", None))
        self.label_description.setText(QCoreApplication.translate("SplashScreen", u"KENDİ YAPAY ZEKANI ÜRET", None))
        self.label_loading.setText(QCoreApplication.translate("SplashScreen", u"yükleniyor...", None))
